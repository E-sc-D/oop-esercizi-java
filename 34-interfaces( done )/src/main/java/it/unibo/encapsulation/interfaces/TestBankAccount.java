...
public class TestBankAccount {
    ...
    public static void main(final String[] args) {
        ...
        AccountHolder acc1 = new AccountHolder("Andrea", "Rossi", 1);
        AccountHolder acc2 = new AccountHolder("Alex", "Bianchi", 2);
        /*
         ...
         */
        BankAccount account1 = new SimpleBankAccount(1, 0);
        BankAccount account2 = new StriktBankAccount(2, 0);
        /*
